...
// 备注：此前的 2D/3D Globe 可视化均已删除，技术页仅保留静态内容
</script>
...
.stat-card .val{font-size:clamp(28px,6.2vw,38px);font-weight:700;line-height:1.05;margin:0 0 6px;background:linear-gradient(88deg,#15345c,#2e7dff 55%,#6ab9ff);background-clip:text;-webkit-background-clip:text;color:transparent;letter-spacing:.6px;}
...
.collab-heading{margin:0 0 12px;font-size:clamp(22px,5vw,30px);font-weight:700;letter-spacing:.6px;background:linear-gradient(90deg,#16406d,#2e7dff 55%,#6ec4ff);background-clip:text;-webkit-background-clip:text;color:transparent}
...
.cat-heading{margin:0 0 10px;font-size:clamp(22px,5vw,30px);font-weight:700;letter-spacing:.6px;background:linear-gradient(90deg,#16406d,#2e7dff 55%,#6ec4ff);background-clip:text;-webkit-background-clip:text;color:transparent}
